...
<template lang='md'>
  ...
  Formerly known as the - legendary - <a href="https://twitter.com/shaneburger/status/1153390540261662720"><i>Metagraph</i></a>, SpeckleViz&trade; has been created to help you get a better understanding of the <b>data flow</b> of a <b>specific Speckle Project</b> across users, streams and documents.

  <v-alert type='info' :value='true' class='my-4'>
  The same way that Microsoft does not take respondibility for how messy your directory structure is on your Windows account, and the same way that Google is not reponsible for how messy your Google Drive is, Speckle is not responsible for how bad your Projects and Streams are named and organized within your Speckle's <a href="/docs/web/management">management interface</a>. As SpeckleViz directly reflects how your Streams are organized and relate to each other within a same Speckle Project, this web app will make more sense if your Streams have been created, named and organized in a meaningful way.
  </v-alert>

  ## Where to find the graph / Overview
  ...
  The SpeckeViz interface is divided into 4 main parts: the toolbar, the time range slider, the tag queries selector and the graph itself.
  ![](~/assets/docs/webapp/speckleviz/specklevizinterface.png){.my-3 .elevation-10}
