...
<template lang='md'>
  ...
  1. As an **open source project**, Speckle is not tied to any one organization and will always be hackable towards the way you choose to use the platform.
  2. Speckle **lives in the cloud**. This allows for data transfer not only from one software to another in a local machine, but also across networks and various web platforms.
  3. The data which is sent through Speckle is fully in the user's control. Rather than having one centralised server, allows you to choose [what happens with your data](/blog/ownyourdata).
