...
<template lang='md'>
  The Grasshopper plugin contains components which allows you to create objects from any installed [schema and object model](../../docs/developers/objectmodels). These three components are grouped under `SpeckleKits` and perform the following functions:
    - <img src="~/assets/docs/clients/grasshopper-dynamo/schema-builder/schemaBuilderIcon.png" style="height:1.5em;"/> Creates a SpeckleObject
    - <img src="~/assets/docs/clients/grasshopper-dynamo/schema-builder/modifyIcon.png" style="height:1.5em;"/> Modifies the properties of a SpeckleObject
    - <img src="~/assets/docs/clients/grasshopper-dynamo/schema-builder/convertIcon.png" style="height:1.5em;"/> Converts to the chosen SpeckleObject
  ...
  ![schemaBuilder](~/assets/docs/clients/grasshopper-dynamo/schema-builder/schemaBuilder.gif) {.my-4 .elevation-10}
  ...
  ![modifyExample](~/assets/docs/clients/grasshopper-dynamo/schema-builder/modifyExample.png) {.my-4 .elevation-10}
  ...
  ![convertExample](~/assets/docs/clients/grasshopper-dynamo/schema-builder/convertExample.png) {.my-4 .elevation-10}
  ...
  ![combinedExample](~/assets/docs/clients/grasshopper-dynamo/schema-builder/combinedExample.png) {.my-4 .elevation-10}
</template>
<script>
export default {
  layout: 'docs',
