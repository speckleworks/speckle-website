...
<template lang='md'>
  ...
  ![gsa](~/assets/docs/clients/gsa/client.png) {.my-4 .elevation-10}
  ...
  ![login](~/assets/docs/clients/gsa/login.png)
  ...
  ![sending](~/assets/docs/clients/gsa/sending.gif) {.my-4 .elevation-10}
  ...
  ![receiving](~/assets/docs/clients/gsa/receiving.gif) {.my-4 .elevation-10}
  ...
  ![results](~/assets/docs/clients/gsa/results.gif) {.my-4 .elevation-10}
