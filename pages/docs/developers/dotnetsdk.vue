...
<template lang='md'>
  <!-- <div class='font-weight-light'> -->
    ...
    Mostly, the focus on this grant will be to standardize and normalize a so called "delta" format - ie, change specifications for design data updates. You will work both on schema definitions (not IFC, don't worry!), but also many other aspects of speckle: the server, client implementations, front-end, etc. You will have a certain freedom in choosing this. Alongside this, you will get to travel to conferences 🌴, talk and learn and enjoy academic working hours 😎. You will be working with data from real projects and case studies 🏗, and essentially shape the future of digital communication infrastructure for the AEC world. What more do you want?

    <!-- # What we're looking for: {.font-weight-thin .mb-2} -->
