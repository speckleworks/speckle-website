...
<template lang='md'>
  ...
  ![3d viewer start](~/assets/docs/viewer/viewer-start.gif) {.my-4 .elevation-10}
  ...
  ![3d viewer groups](~/assets/docs/viewer/grouping.gif) {.my-4 .elevation-10}
  ...
  ![3d viewer groups](~/assets/docs/viewer/filtering.gif) {.my-4 .elevation-10}
  ...
  ![3d viewer groups](~/assets/docs/viewer/object-properties.png)
