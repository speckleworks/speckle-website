...
<template lang='md'>
  ...
  ![modifyExample](~/assets/docs/schema-builder/modifyExample.png) {.my-4 .elevation-10}
  ...
  ![combinedExample](~/assets/docs/schema-builder/combinedExample.png) {.my-4 .elevation-10}
